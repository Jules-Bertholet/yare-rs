...
extern "C" {
	...
	#[wasm_bindgen(module = "node-modules/yare-code-sync/client/RenderService", js_namespace=RenderService, js_name = "circle")]
	...
	#[wasm_bindgen(module = "node-modules/yare-code-sync/client/RenderService", js_namespace=RenderService, js_name = "line")]
	pub fn line_color(pos1: &Position, pos2: &Position, color: &str);

	#[wasm_bindgen(module = "node-modules/yare-code-sync/client/RenderService", js_namespace=RenderService)]
	pub fn text(pos: &Position, str: &str);

	#[wasm_bindgen(module = "node-modules/yare-code-sync/client/RenderService", js_namespace=RenderService, js_name = "text")]
	pub fn text_color(pos: &Position, str: &str, color: &str);

	#[wasm_bindgen(module = "node-modules/yare-code-sync/client/RenderService", js_namespace=RenderService)]
	pub fn log(str: &str);

	#[wasm_bindgen(module = "node-modules/yare-code-sync/client/RenderService", js_namespace=RenderService, js_name = "log")]
